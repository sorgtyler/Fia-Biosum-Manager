	...
	public class RunOptimizer
	{
		...
		private void validcombos()
		{
           ...
           "WHERE b.simyear4_rx IS NOT NULL AND LEN(TRIM(b.simyear4_rx)) > 0 AND b.simyear4_rx<>'000'";
            ...
            if ((bool)frmMain.g_oDelegate.GetControlPropertyValue((System.Windows.Forms.Control)oCheckBox, "Checked", false) == true)
			{
                ...
                if (frmMain.g_bDebug && frmMain.g_intDebugLevel > 1)
                    frmMain.g_oUtils.WriteText(m_strDebugFile, "\r\n--cond_audit--\r\n\r\n");
                this.m_strSQL = "INSERT INTO " + Tables.Audit.DefaultCondAuditTableName + " (biosum_cond_id) SELECT ruledefinitionscondfilter.biosum_cond_id FROM ruledefinitionscondfilter INNER JOIN userdefinedplotfilter ON ruledefinitionscondfilter.biosum_plot_id = userdefinedplotfilter.biosum_plot_id";
                if (frmMain.g_bDebug && frmMain.g_intDebugLevel > 1)
		...
		private void CreateTableStructureForPSiteSum()
		{
			...
			if (oAdo.m_intError==0)
			{
				...
				frmMain.g_oTables.m_oOptimizerScenarioResults.CreateOptimizationPSiteSumTable(oAdo,
			...
			if (oAdo.m_intError==0)
			{
				if (oAdo.TableExist(oAdo.m_OleDbConnection,"own_sum_work_table"))
					oAdo.SqlNonQuery(oAdo.m_OleDbConnection,"DROP TABLE own_sum_work_table");
						frmMain.g_oTables.m_oOptimizerScenarioResults.CreateOptimizationOwnershipSumTable(
							oAdo,
        ...
        /// ECON_BY_RX_CYCLE, and effective tables
		/// </summary>
        ...
        private void TreatmentAcreageExpansionByPlot()
        {
            ...
            if (frmMain.g_bDebug && frmMain.g_intDebugLevel > 1)
                frmMain.g_oUtils.WriteText(m_strDebugFile, "\r\n\r\n Treatments Acreage Expansion By Plot\r\n");
            if (frmMain.g_bDebug && frmMain.g_intDebugLevel > 1)
                frmMain.g_oUtils.WriteText(m_strDebugFile, "-----------------------------------------\r\n");
            ...
            string strInsertSql = "INSERT INTO " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPlotRxCostRevenueVolumesTableName + " " +
                                  "(biosum_cond_id, rxpackage,rx,rxcycle," +
            ...
            this.m_strSQL = "SELECT  " +
                            Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + ".biosum_cond_id," +
                            Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + ".rxpackage," +
                            Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + ".rx," +
                            Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + ".rxcycle," +
                             this.m_strCondTable + ".owngrpcd," +
                            "ROUND(" + this.m_strCondTable + ".acres,10) AS acres," +
                             Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteAccessibleWorkTableName + ".merch_haul_psite," +
                            "ROUND(" + Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteAccessibleWorkTableName + ".merch_haul_cost_dpgt * " + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + ".merch_wt_gt * acres,10) AS merch_haul_cost_exp," +
                            ...
                            "ROUND(" + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + ".merch_val_dpa * acres,10) AS merch_dollars_val_exp," +
                             Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteAccessibleWorkTableName + ".chip_haul_psite," +
                            "ROUND(" + Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteAccessibleWorkTableName + ".chip_haul_cost_dpgt * " + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + ".chip_wt_gt * acres,10) AS chip_haul_cost_exp," +
                            ...
                            " INNER JOIN (" + Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteAccessibleWorkTableName + " " +
                            "INNER JOIN " + this.m_strCondTable + " " +
                            "ON " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteAccessibleWorkTableName + ".biosum_cond_id = " +
                                    this.m_strCondTable + ".biosum_cond_id) " +
            ...
            strInsertSql = "INSERT INTO " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPlotRxPackageCostRevenueVolumesSumTableName + " " +
                                  "(biosum_cond_id, rxpackage," +
                                   "owngrpcd,acres,merch_haul_cost_psite," +
            ...
            this.m_strSQL = "SELECT DISTINCT " +
                                ...
                                "b.harv_costs_sum," +
                                "b.haul_costs_sum " +
                            "FROM " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPlotRxCostRevenueVolumesTableName + " a,";
            ...
            string strSumSQL ="(SELECT  " +
                           ...
                           "FROM " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPlotRxCostRevenueVolumesTableName + " " + 
        ...
        private void TreatmentAcreageExpansionByPSite()
        {
            ...
            frmMain.g_oTables.m_oOptimizerScenarioResults.CreatePSiteRxCostsRevenuesVolumesSumTable(m_ado, m_TempMDBFileConn, "psite_rxpackage_rx_rxcycle_sum_work_table");
           ...
           // this.m_txtStreamWriter.WriteLine("Execute SQL:" + this.m_strSQL);
            ...
            strInsertSql = "INSERT INTO " + 
                            Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteRxCostRevenueVolumesTableName + " " + 
            ...
            strInsertSql = "INSERT INTO " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteRxPackageCostRevenueVolumesTableName + " " +
                                  "(rxpackage,psite_id," +
            ...
            this.m_strSQL = "SELECT DISTINCT " +
                            ...
                            "FROM " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteRxCostRevenueVolumesTableName + " a,";
            ...
            string strSumSQL = "(SELECT  " +
                           ...
                           "FROM " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteRxCostRevenueVolumesTableName + " " +
        ...
        private void TreatmentAcreageExpansionByOwner()
        {
            ...
            frmMain.g_oTables.m_oOptimizerScenarioResults.CreateOwnerRxCostsRevenuesVolumesSumTable(m_ado, m_TempMDBFileConn, "own_rxpackage_rx_rxcycle_sum_work_table");
            ...
            this.m_strSQL = "INSERT INTO own_rxpackage_rx_rxcycle_sum_work_table " +  
                ...
                "FROM " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPlotRxCostRevenueVolumesTableName + " GROUP BY rxpackage,rx,rxcycle,owngrpcd ;";
            ...
            this.m_strSQL = "INSERT INTO " + Tables.OptimizerScenarioResults.DefaultScenarioResultsOwnerRxCostRevenueVolumesTableName + " " +
           ...
           // this.m_txtStreamWriter.WriteLine("Sum acreage expansion totals by ownership for a Treatment Package");
            string strInsertSql = "INSERT INTO " + Tables.OptimizerScenarioResults.DefaultScenarioResultsOwnerRxPackageCostRevenueVolumesTableName + " " +
                                  "(rxpackage,owngrpcd," +
                                   "acres,merch_haul_cost_psite," +
                                   "merch_haul_cents,merch_vol,merch_dollars_val," +
                                   "chip_haul_cost_psite,chip_haul_cents,chip_yield," +
            ...
            this.m_strSQL = "SELECT DISTINCT " +
                                ...
                                "b.sum_harv_costs AS harv_costs," +
                                "b.sum_haul_costs AS haul_costs " +
                            "FROM " + Tables.OptimizerScenarioResults.DefaultScenarioResultsOwnerRxCostRevenueVolumesTableName + " a,";
            ...
            string strSumSQL = "(SELECT  " +
                           ...
                           "SUM(IIF(harv_costs IS NULL,0,harv_costs)) AS sum_harv_costs," +
                           "SUM(IIF(haul_costs IS NULL,0,haul_costs)) AS sum_haul_costs " +
                           "FROM " + Tables.OptimizerScenarioResults.DefaultScenarioResultsOwnerRxCostRevenueVolumesTableName + " " +
		...
		{
            string p = Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteAccessibleWorkTableName;
			string c = this.m_strCondTable.Trim();

           
            //create work table to eliminate duplicates
            frmMain.g_oTables.m_oOptimizerScenarioResults.CreateBestRxStandOptimizationSummaryCycle1Table(
                m_ado,
                m_TempMDBFileConn,
            ...
            this.m_strSQL += " SELECT a.biosum_cond_id," +
                                     ...
                                     "a.max_nr_dpa," +
                                     "a.usebiomass_yn " +
                           "FROM cycle1_effective_" + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + " a";
            ...
            this.m_strSQL += " SELECT  DISTINCT " + 
				...
				p + ".merch_haul_psite," +
                "ROUND(" + p + ".merch_haul_cost_dpgt * " + strBestRxSummaryTableName + ".acres,10) AS merch_haul_cpa," +
				...
				p + ".chip_haul_psite," +
                "ROUND(" + p + ".chip_haul_cost_dpgt * " + strBestRxSummaryTableName + ".acres,10) AS chip_haul_cpa," +
				...
				"INNER JOIN (" + p + 
				" INNER JOIN " + c + 
				" ON " + p + ".biosum_cond_id = " + c + ".biosum_cond_id) " + 
