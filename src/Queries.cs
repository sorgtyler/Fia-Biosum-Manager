...
namespace FIA_Biosum_Manager
{
	...
	public class Queries
	{
		...
		public class FVS
		{
			...
			public string m_strTreeDbhGrpTable;
			...
			public void LoadDatasources()
			{
				...
				m_strTreeDbhGrpTable = ReferenceQueries.m_oDataSource.getValidDataSourceTableName("TREE DIAMETER GROUPS");
				...
				if (m_strTreeDbhGrpTable.Trim().Length == 0)
				{
					MessageBox.Show("!!Could not find tree diameter group table!!",
						"FIA Biosum",
						System.Windows.Forms.MessageBoxButtons.OK,
						System.Windows.Forms.MessageBoxIcon.Exclamation);
					ReferenceQueries.m_intError=-1;
