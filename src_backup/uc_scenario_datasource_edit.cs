...
{
	/// <summary>
	/// Summary description for uc_scenario_datasource_edit.
	/// </summary>
	public class uc_scenario_datasource_edit : System.Windows.Forms.UserControl
	{
		...
		public uc_scenario_datasource_edit()
		{
		...
		private void InitializeComponent()
		{
			...
			this.btnCopy.Size = new System.Drawing.Size(248, 24);
			this.btnCopy.TabIndex = 29;
			this.btnCopy.Text = "Copy Table To A Different MDB File";
			...
			this.btnMove.Size = new System.Drawing.Size(248, 24);
			this.btnMove.TabIndex = 27;
			this.btnMove.Text = "Move Table To A Different MDB File";
			...
			this.btnFile.Size = new System.Drawing.Size(248, 24);
			this.btnFile.TabIndex = 8;
			this.btnFile.Text = "Get An MDB File And Table";
			...
			this.lblTitle.Text = "Scenario Data Source Edit";
			// 
			// lblProgress
			// 
			this.lblProgress.Location = new System.Drawing.Point(8, 432);
			...
			// 
			// uc_scenario_datasource_edit
			// 
			this.Controls.Add(this.groupBox1);
			this.Name = "uc_scenario_datasource_edit";
			this.Size = new System.Drawing.Size(696, 456);
			this.Resize += new System.EventHandler(this.uc_scenario_datasource_edit_Resize);
		...
		private void btnFile_Click(object sender, System.EventArgs e)
		{
			...
			strFullPath = this.lblMDBFile.Text ;
		...
		private void uc_scenario_datasource_edit_Resize(object sender, System.EventArgs e)
		{
             this.resize_uc_scenario_datasource_edit();
		}
		public void resize_uc_scenario_datasource_edit()
		{
		...
		private void btnCommitChange_Click(object sender, System.EventArgs e)
		{
			...
			switch (strAction)
			{
				case "copy":
					...
					tempDao.MoveTableToMDB(this.lblNewMDBFile.Text,
						this.lblNewTable.Text,
						this.lblMDBFile.Text,
						this.lblTable.Text,false,ref this.lblProgress);
					if (tempDao.m_intError == 0) 
					{
						...
						strConn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + 
							this.m_strProjectDirectory + "\\core\\db" + 
							"\\" + this.m_strScenarioFile + ";User Id=admin;Password=;";

						strSQL = "UPDATE scenario_datasource SET path = '" + strDir + "', " +
							"file = '" +  strFile + "', " +
				...
				case "move":
					...
					tempDao.MoveTableToMDB(this.lblNewMDBFile.Text,
						                   this.lblNewTable.Text,
						                   this.lblMDBFile.Text,
						                   this.lblTable.Text,true,ref this.lblProgress);
					if (tempDao.m_intError == 0) 
					{
						...
						strConn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + 
							      this.m_strProjectDirectory + 
 					              "\\core\\db\\" + this.m_strScenarioFile + ";User Id=admin;Password=;";
		...
		private void PerformAction()
		{
			...
			OpenFileDialog1.Filter = "Access Database File (*.MDB) |*.mdb";
			strMDBFileDestination = this.lblMDBFile.Text ;
			...
			if (result == DialogResult.OK)
			{
				...
				if (strMDBFileDestination.Length > 0) 
				{
					...
					strMDBFileSource = this.lblMDBFile.Text.ToString();
